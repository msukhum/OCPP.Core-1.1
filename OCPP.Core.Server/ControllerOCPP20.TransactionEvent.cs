    ...
    public partial class ControllerOCPP20
    {
        public string HandleTransactionEvent(OCPPMessage msgIn, OCPPMessage msgOut)
        {
            ...
            try
            {
                ...
                {
                    UpdateConnectorStatus(connectorId, null, null, meterKWH, currentChargeKW, stateOfCharge, meterTime);
                }
                ...
                if (transactionEventRequest.EventType == TransactionEventEnumType.Started)
                {
                    try
                    {
                        ...
                        using (OCPPCoreContext dbContext = new OCPPCoreContext(Configuration))
                        {
                            ...
                            {
                                UpdateConnectorStatus(connectorId, ConnectorStatusEnum.Occupied.ToString(), meterTime, null, null, null, null);
