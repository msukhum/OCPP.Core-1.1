        ...
        public string HandleDataTransfer(OCPPMessage msgIn, OCPPMessage msgOut)
        {
            ...
            try
            {
                ...
                if (ChargePointStatus != null)
                {
                    ...
                    msgWritten = WriteMessageLog(ChargePointStatus.Id, null, "CP", "Request", msgIn.Action, string.Format("VendorId={0} / MessageId={1} / Data={2}", dataTransferRequest.VendorId, dataTransferRequest.MessageId, dataTransferRequest.Data), errorCode);
